...
<div class="container">
    <h2>문의사항</h2>
    <form action="${contextPath}/board/helpRegister" method="post">
  ...
  <button class="btn-submit" type="submit"  onclick="return confirmConfirm()">전송</button>
    <a href="${contextPath}"class="btn btn-primary" onclick="return confirmCancel()">취소</a>
