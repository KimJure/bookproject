...
<body class="bg-gradient-primary">
                                ...
                                <div class="p-5">
                                    <div class="text-center">
									    ...
									    <div class="form-group">
									        <input type="text" class="form-control form-control-user" id="id" name="id" aria-describedby="emailHelp" placeholder="Enter ID">
									    </div>
									    <div class="form-group">
									...
									<div id="loginErrorMessage" style="display: none; color: red;">${loginErrorMessage}</div>
									<hr>
									...
									<div class="text-center">
									    <a class="small" href="joinMemberview">Create an Account!</a>
									</div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
    var errorMessage = document.getElementById('loginErrorMessage').innerText;
    if (errorMessage) {
